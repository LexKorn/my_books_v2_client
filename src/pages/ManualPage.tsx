...
const ManualPage: React.FC = () => {
    return (
        <Container style={{width: '70%'}} className="manual">
            ...
            <h1 className="manual__title">Несколько рекомендаций</h1>
            <ol className="manual__list">
                <li>Для рейтинга книг используется 10-бальная шкала. Каждый может сам придумать как ранжировать книги.<br/>
                    ...
                    <ul>
                        ...
                        <li>6 - нормально +</li>
                        <li>5 - средне</li>
                        <li>4 - ниже среднего</li>
                        <li>3 - НЕ понравилась</li>
                ...
                <li>Чтобы авторов и книги фильтровать на Отечественные и Зарубежные - при создании автора необходимо указать страну Россия либо СССР.</li>
            </ol>
        </Container>
    );
};
